  ...
  return (
    <section id="Service" className="bg-slate-200 py-20 text-center">
        ...
        <div className="mt-14 mx-10 flex flex-col-reverse sm:flex-row sm:justify-evenly justify-center">
            <div className="bg-white px-3 leading-7 shadow-2xl h-[300px] flex flex-col w-96 py-9 items-center text-center rounded hover:translate-y-[-4%] transition duration-500">
            ...
            <div className="bg-white px-3 leading-7 shadow-2xl h-[300px] mb-10 flex flex-col w-96 py-9 items-center text-center rounded hover:translate-y-[-4%] transition duration-500">
