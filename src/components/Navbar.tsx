...
const Navbar = () => {
  return (
    <section id='header' className='flex justify-between items-center h-auto py-10 text-white px-9'>
        ...
        <nav >
            <ul className="flex items-center">
                <li><a href="#" className="text-xl px-3 hover:opacity-80" id="Home">Home</a></li>
                <li><a href="#" className="text-xl px-3 hover:opacity-80">About</a></li>
                ...
                <button className="border-2  py-3 px-7 font-bold rounded-3xl hover:bg-blue-600 hover:border-blue-600 hover:opacity-90"><a href="">Sign In</a></button>
            </ul>
        </nav>
    </section>
  )
