...
const SignUp = () => {
  ...
  return (
      <section className=" text-white flex justify-center items-center" id="Register">
        <div id="regMain" className=" py-8 px-10 rounded-[12px]">
          ...
          <button id="registerBtn"  className={isChecked ? "h-14 mb-2 w-[100%] text-center bg-transparent border-2 hover:bg-white hover:text-blue-700 hover:opacity-90 ease-in-out hover:border-blue-700 rounded-[6px] text-2xl font-extrabold tracking-wider" : "h-14 mb-2 w-[100%] text-center bg-transparent border-2 hover:opacity-50 ease-in-out  rounded-[6px] text-2xl font-extrabold tracking-wider opacity-50"}>REGISTER </button>
